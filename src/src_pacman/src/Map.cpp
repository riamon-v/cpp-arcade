...
// Last update Thu Apr 13 22:23:00 2017 Melvin Personnier
//
...
void Map::init()
{
  ...
  generateIsland(9, 9, 3, 1); // 8
  generateIsland(10, 6, 7, 2); // 9
  generateIsland(13, 8, 1, 2); // 10
  generateIsland(15, 9, 3, 1); // 11
  ...
  generateIsland(10, 11, 7, 1); // h
  generateIsland(10, 16, 7, 1); // b
  generateIsland(10, 11, 1, 5); // g
  generateIsland(16, 11, 1, 5); // d
  _map[11][13] = Map::DOOR;
}
